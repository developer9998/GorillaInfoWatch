...
internal class SettingsListScreen : InfoScreen
{
    ...
    public void Awake()
    {
        ...
        dictionary["Privacy"].Entries.Insert(0, new ConfigurableWrapper_Woaw<PlayerConsent>("Consent", str.ToString(), () => SignificanceManager.Instance.Consent, consent => SignificanceManager.Instance.SetConsent(consent)));
