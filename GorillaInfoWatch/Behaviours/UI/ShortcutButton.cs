...
namespace GorillaInfoWatch.Behaviours.UI
{
    public class ShortcutButton : MonoBehaviour
    {
        ...
        public void OnTriggerEnter(Collider other)
        {
            ...
            if (other.TryGetComponent(out HandIndicator handIndicator) && handIndicator.isLeftHand != Watch.LocalWatch.InLeftHand && Main.Instance.CheckInteractionInterval(WatchInteractionSource.Shortcut, 0.25f, false))
            {
        ...
        public void OnTriggerExit(Collider other)
        {
            ...
            Main.Instance.SetInteractionInterval(WatchInteractionSource.Shortcut);
        }
