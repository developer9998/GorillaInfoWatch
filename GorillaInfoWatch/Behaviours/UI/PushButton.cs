...
public class PushButton : MonoBehaviour
{
    ...
    [SerializeField] [HideInInspector] private bool bumped;
    ...
    {
        if (Time.realtimeSinceStartup > PressTime && collider.TryGetComponent(out HandIndicator component) &&
    ...
    public void AssignWidget(Widget_PushButton widget)
    {
        if (widget is not null)
        {
            ...
            OnButtonPressed = () => { Widget.Command?.Invoke(Widget.Parameters ?? []); };
