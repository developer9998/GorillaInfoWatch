...
namespace GorillaInfoWatch.Models
{
    public class PageBuilder(params List<Section> pages) : InfoContent
    {
        ...
        public PageBuilder Add(SectionDefinition definition, ILineBuilder lineProvider) => Add(new Section(definition, lineProvider));

        public PageBuilder Add(string title, ILineBuilder lineProvider) => Add(new Section(title, lineProvider));

        public PageBuilder Add(string title, string description, ILineBuilder lineProvider) => Add(new Section(title, description, lineProvider));

        public PageBuilder Add(ILineBuilder lineProvider) => Add(new Section(lineProvider));
