...
{
    public static readonly Gradient Button =
            CreatePalette(new Color32(191, 188, 170, 255), new Color32(132, 131, 119, 255));
    ...
    public static readonly Gradient Yellow =
            CreatePalette(new Color32(215, 211, 40, 255), new Color32(189, 185, 14, 255));

    public static readonly Gradient White =
            CreatePalette(new Color32(243, 243, 243, 255), new Color32(217, 217, 217, 255));

    public static readonly Gradient Black = CreatePalette(new Color32(73, 73, 73, 255), new Color32(48, 48, 48, 255));

    public static readonly Gradient Magenta =
            CreatePalette(new Color32(246, 9, 213, 255), new Color32(220, 0, 187, 255));
    ...
    public static Gradient CreatePalette(params List<Color> colours)
    {
        ...
        for (int i = 0; i < colours.Count; i++)
        {
            ...
            colourKeys.Add(new GradientColorKey(colours[i], time));
            alphaKeys.Add(new GradientAlphaKey(colours[i].a, time));
        }
    ...
    public static Color GetColour(this Gradient gradient, int index)
    {
        ...
        if (gradient.colorKeys == null)
            throw new ArgumentException("Gradient has missing colour keys", nameof(gradient));
