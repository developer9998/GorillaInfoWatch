...
public class Symbol
{
    ...
    public Symbol(Sprite sprite) => Sprite = sprite;
    ...
    public bool Equals(Symbol symbol) =>
            symbol.Sprite == Sprite && symbol.Colour == Colour && symbol.Material == Material;

    public static implicit operator Symbol(Symbols enumeration) =>
            SymbolFromEnum.TryGetValue(enumeration, out Symbol symbol) ? symbol : new Symbol(enumeration);
