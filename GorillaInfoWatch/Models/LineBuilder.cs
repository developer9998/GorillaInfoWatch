...
public class LineBuilder(List<InfoLine> lines) : InfoContent
{
    ...
    public LineBuilder(string content) : this([
                                                      .. content.Split(Environment.NewLine)
                                                                .Select(line => new InfoLine(line)),
                                              ]) { }
    ...
    public override IEnumerable<InfoLine> GetLinesAtSection(int section) =>
    ...
    {
        Lines.Add(new InfoLine(text, widgets));
    ...
    {
        Lines.Insert(position, new InfoLine(text, widgets));
    ...
    {
        Lines.AddRange(Enumerable.Repeat<InfoLine>(new InfoLine(text, widgets), amount));
