...
public class Menu_Home(InfoWatch watch) : Menu_StateBase(watch)
{
    ...
    public override void Initialize()
    {
        ...
        targetRig = isLocalWatch
                            ? VRRigCache.Instance.localRig
                            : Watch.Rig.rigContainer ?? Watch.Rig.GetComponent<RigContainer>();
    }
    ...
    public override void Update()
    {
        ...
        if (NetworkSystem.Instance.InRoom)
        {
            try
            {
                ...
                if (isLocalWatch
                            ? !targetRig.Rig.mySpeakerLoudness.IsMicEnabled || !recorder.TransmitEnabled
                            : targetRig.Muted || !targetRig.Rig.mySpeakerLoudness.IsMicEnabled)
                {
                ...
                bool isSpeaking = isLocalWatch
                                          ? recorder.IsCurrentlyTransmitting
                                          : targetRig.Voice is PhotonVoiceView voice && voice && voice.IsSpeaking;
