...
public sealed class Widget_Switch(bool value, Action<bool, object[]> action, params object[] parameters) : Widget_Base
{
    ...
    public Gradient Colour =
            ColourPalette.CreatePalette(ColourPalette.Red.GetInitialColour(), ColourPalette.Green.GetInitialColour());
    ...
    public Widget_Switch(bool value, Action<object[]> action, params object[] parameters) : this(value,
            (value, args) => action(args), parameters)
    {
        // Must declare a body
    }
